        ...
        <Container text textAlign='center'  >
            ...
            <Card.Group>
                <Card centered fluid>
                    ...
                    <Button color='youtube' style={{display:this.state.showbutton}} onClick={this.pickWinner}>开奖</Button>
                    <Button color='black' style={{display:this.state.showbutton}} onClick={this.refund}>退钱</Button>
                </Card>
            </Card.Group>
